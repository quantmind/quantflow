...
from .slippage import (VolumeShareSlippage, transact_partial,
                       check_order_triggers)
from .commission import PerShare
...
class Order(object):
    ...
    def status(self):
        ...
        return ORDER_STATUS.FILLED \
            if not self.open_amount else ORDER_OPEN
